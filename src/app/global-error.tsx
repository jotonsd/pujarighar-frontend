      ...
      <body>
        <div style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "sans-serif", background: "#fff", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", textAlign: "center", animation: "fadeIn 0.5s ease-out" }}>
            <p style={{ fontSize: "5.5rem", fontWeight: 800, color: "#111827", margin: 0, lineHeight: 1 }}>500</p>
            <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#1f2937", margin: "0.75rem 0" }}>ওহো! অভ্যন্তরীণ সার্ভার সমস্যা</h1>
            <p style={{ color: "#6b7280", marginBottom: "2rem" }}>কিছু একটা ভুল হয়েছে আমাদের দিক থেকে। কিছুক্ষণ পর আবার চেষ্টা করুন।</p>
            <button
              onClick={reset}
              style={{ padding: "0.75rem 1.75rem", borderRadius: "0.75rem", background: "#d97706", color: "#fff", border: "none", fontWeight: 600, fontSize: "1rem", cursor: "pointer" }}
            >
              আবার চেষ্টা করুন
            </button>
