      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            {/* Newsletter */}
            <div className="mt-5">
              <p className="text-xs text-gray-500 mb-2">{bn ? 'নিউজলেটার সাবস্ক্রাইব করুন' : 'Subscribe to newsletter'}</p>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-500">
            © {year} PujariGhar. {bn ? 'সর্বস্বত্ব সংরক্ষিত।' : 'All rights reserved.'}
          </p>
          ...
          <div className="flex items-center gap-1.5 text-xs text-gray-600">
            ...
            {['bKash', 'Nagad', 'COD'].map(p => (
              <span key={p} className="bg-gray-800 px-2 py-0.5 rounded text-gray-400">{p}</span>
            ))}
          </div>
        </div>
      </div>
