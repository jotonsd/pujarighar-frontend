...
const statusVariants: Record<OrderStatus, 'gray' | 'blue' | 'yellow' | 'orange' | 'green' | 'red'> = {
  PENDING:    'yellow',
  CONFIRMED:  'blue',
  PACKED:     'blue',
  ASSIGNED:   'orange',
...
export default function OrderStatusBadge({ status, locale }: { status: OrderStatus; locale: string }) {
  return (
