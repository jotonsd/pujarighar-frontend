...
import { HeroSlide, useCreateHeroSlideMutation, useUpdateHeroSlideMutation } from '@/api/heroSlides/heroSlidesApi'
...
export default function SlideForm({ editItem, onClose }: Props) {
  ...
  const [form, setForm] = useState(editItem ? {
    ...
    cta_label_bn: editItem.cta_label_bn, cta_label_en: editItem.cta_label_en,
    cta_link: editItem.cta_link, bg_color: editItem.bg_color, order: editItem.order,
  } : { ...EMPTY_FORM })
  ...
  return (
    <div className="card mb-6 space-y-4">
      <h2 className="font-semibold text-gray-700">
        {editItem ? (locale === 'bn' ? 'স্লাইড সম্পাদনা' : 'Edit Slide') : (locale === 'bn' ? 'নতুন স্লাইড' : 'New Slide')}
      </h2>
