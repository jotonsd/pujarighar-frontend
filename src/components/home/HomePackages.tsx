...
export default function HomePackages() {
  ...
  const { data, isLoading } = useGetProductsQuery({ is_package: 'true', page_size: 6 })
  ...
  return (
    <section className="mb-12">
      <div className="flex items-center justify-between mb-5">
        ...
        <Link href={`/${locale}/packages`} className="text-sm text-amber-600 hover:underline font-medium">
